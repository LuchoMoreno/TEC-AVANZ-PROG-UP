...
betsRouter.post("/bets", Middleware.verify, async (req,res) =>{
    ...
    try{
      ...
      console.log(result);
      res.status(201).send(`Apuesta cargada correctamente. Los posibles ingresos de la apuesta seran: $${result.savedBet.payout}. Dinero disponible: $${result.userParam.money}`); // 201
